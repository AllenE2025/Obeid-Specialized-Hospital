    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        ...
        <View style={styles.headerContent}>
          ...
          <FontAwesome6 name="flask" size={100} color="black" />
            <Text style={styles.title}>Laboratory Result</Text>
          </View>

          <Text style={styles.subtitle}>Access secure laboratory result</Text>
